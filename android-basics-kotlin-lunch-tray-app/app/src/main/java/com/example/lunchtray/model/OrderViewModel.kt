...
class OrderViewModel : ViewModel() {
    ...
    fun setEntree(entree: String) {
        ...
        val menuItem = menuItems[entree]!!
        _entree.value = menuItem
    ...
    fun setSide(side: String) {
        ...
        val menuItem = menuItems[side]!!
        _side.value = menuItem
        updateSubtotal(menuItem.price)
    }
    ...
    fun setAccompaniment(accompaniment: String) {
        ...
        val menuItem = menuItems[accompaniment]!!
        _accompaniment.value = menuItem
        updateSubtotal(menuItem.price)
    }
